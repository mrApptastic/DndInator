...
public class ArmorScraper
{
    ...
    public static async Task<List<Armor>> ScrapeArmor2014()
    {
        var candidateUrls = new[]
        {
            "https://dnd5e.wikidot.com/armor",
            "https://dnd5e.wikidot.com/equipment:armor"
        };
        ...
        using (var client = new HttpClient())
        {
            ...
            foreach (var armorUrl in candidateUrls)
            {
                try
                {
                ...
                {
                    Console.WriteLine($"Error scraping armor from {armorUrl}: {ex.Message}");
                }
            }
        }
