...
public class ToolScraper
{
    ...
    public static async Task<List<Tool>> ScrapeTools2014()
    {
        var candidateUrls = new[]
        {
            "https://dnd5e.wikidot.com/tools",
            "https://dnd5e.wikidot.com/equipment:tool"
        };
        ...
        using (var client = new HttpClient())
        {
            ...
            foreach (var toolUrl in candidateUrls)
            {
                try
                {
                ...
                {
                    Console.WriteLine($"Error scraping tools from {toolUrl}: {ex.Message}");
                }
            }
        }
